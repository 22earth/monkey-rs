...
impl<'a> Lexer<'a> {
    ...
    pub fn next_token(&mut self) -> Token {
        ...
        let t = match self.ch {
            ...
            '*' => Punctuator::Mul.into(),
            '/' => Punctuator::Div.into(),
            '<' => Punctuator::LessThan.into(),
            '>' => Punctuator::GreaterThan.into(),
            ...
            '"' => {
                ...
                return Token {
                    span: Span { start, end },
                    kind: TokenKind::string_literal(str),
                };
            }
            _ => {
